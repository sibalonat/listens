<template>
  ...
  <div>
    ...
    <Section class="h-screen pt-16 bg-gray-800">
      <div class="flex flex-wrap content-between h-2/3 pb-36">
        ...
        >
          Digital Eco jasjkhfasjkdhfjashdfjkashdfaskfdhsafa sr fullsgtack
          developer nice to finally meet you
        </p>
    ...
    <!-- second section -->
    <Section class="h-screen text-gray-800 bg-gray-200" id="skills">
      ...
      <div class="flex justify-center mt-10">
        <JetButton
          class="text-sm font-bold text-gray-800 bg-indigo-400 rounded hover:bg-green-800"
          @click="contacting = true"
          >
          {{ $page.props.flash.contacted ? 'Thanks' : 'Know more' }}
          </JetButton
    ...
    <Section class="flex justify-between text-xl text-gray-300 bg-gray-800">
      ...
      <div class="flex items-center justify-evenly">
        <Link class="px-2 pb-1 border-b hover:text-gray-500" href="#"
          >github</Link
        >
        <Link class="px-2 pb-1 border-b hover:text-gray-500" href="#"
          >twitter</Link
  ...
  <jet-modal :show="contacting" closeable="true" @close="contacting = null">
    ...
    <div
      class="p-8 font-bold text-center bg-green-400 shadow-2xl"
